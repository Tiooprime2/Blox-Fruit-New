...
local THEME = {
    ...
    ACCENT       = Color3.fromRGB(160, 130, 255),   -- Ungu Claude
...
local function closeUI()
    ...
    tween(mainFrame, 0.2, {Size = UDim2.new(0, 360, 0, 0)}):Play()
...
local function openUI()
    ...
    tween(mainFrame, 0.25, {Size = UDim2.new(0, 360, 0, 230)}):Play()
    openBtn.Visible = false
end
...
mainFrame.Size = UDim2.new(0, 360, 0, 0)
tween(mainFrame, 0.35, {Size = UDim2.new(0, 360, 0, 230)}):Play()
...
local function createToggle(page, name, desc, defaultState, callback)
    ...
    row.Parent = page
    corner(row, 8)
    stroke(row, state and THEME.ACCENT_DIM or THEME.BORDER, 1, 0.5)
